...
# doc/client.xml:91-96
gap> G:=DihedralGroup(64);
<pc group of size 64 with 6 generators>
gap> IdGroupWS(G);
[ 64, 52 ]

# doc/client.xml:109-112
gap> x := [ Z(3)^0, Z(3), 0*Z(3) ];
[ Z(3)^0, Z(3), 0*Z(3) ]

# doc/client.xml:114-147
gap> OMPrint( x );
